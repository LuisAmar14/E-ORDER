...
const MostP: React.FC = () => {
  ...
  return (
    <Box sx={{ flexGrow: 1, p: 0, backgroundColor: '#f9f9f9', padding: '20px' }}>
          ...
          <Grid item xs={12} sm={6} md={4} key={product.id}>
            <Card sx={{ display: 'flex', flexDirection: 'column', height: '100%', position: 'relative', boxShadow: '0px 4px 12px rgba(0, 0, 0, 0.1)' }}>
              ...
              <CardContent sx={{ flexGrow: 1 }}>
                <Typography gutterBottom variant="h5" component="div" sx={{ color: '#2b364a' }}>
                  {product.name}
                </Typography>
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', pl: 1, pb: 1 }}>
                ...
                <Button 
                  ...
                  sx={{ ml: 'auto', mr: 1, backgroundColor: '#2b364a', '&:hover': { backgroundColor: '#1f2c3a' } }}
                >
                  Add to Cart
                </Button>
              </Box>
